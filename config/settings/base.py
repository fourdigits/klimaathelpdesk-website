...
APPS_DIR = ROOT_DIR.path("klimaat_helpdesk")
...
MIGRATION_MODULES = {"sites": "klimaat_helpdesk.contrib.sites.migrations"}
...
ADMINS = [("""Aquiles Carattino""", "aqui.carattino@gmail.com")]
...
ACCOUNT_ADAPTER = "klimaat_helpdesk.users.adapters.AccountAdapter"
